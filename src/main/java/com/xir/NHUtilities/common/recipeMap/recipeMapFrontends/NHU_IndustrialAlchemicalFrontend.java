package com.xir.NHUtilities.common.recipeMap.recipeMapFrontends;
...
public class NHU_IndustrialAlchemicalFrontend extends RecipeMapFrontend {

    private static final int xDirMaxCount = 2;
    private static final int yOrigin = 8;
    private final int itemRowCount;

    public NHU_IndustrialAlchemicalFrontend(BasicUIPropertiesBuilder uiPropertiesBuilder,
