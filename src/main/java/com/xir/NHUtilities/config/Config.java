...
public class Config {
    ...
    private static final String CATEGORY_WIRELESS = "Wireless_Hatch_More";
    // endregion
    ...
    static {
        categoryInit();
        {
            ...
            enableBanOriginalWirelessRecipes = configuration.getBoolean(
    ...
    private static void categoryInit() {
        ...
        configuration.addCustomCategoryComment(CATEGORY_WIRELESS, "More Wireless Hatch!");
    }
}
